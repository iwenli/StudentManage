 ...
 * 名    称：ExcelHelper
 * 功    能：Excel操作类
 * 来    历：HUCSD 创建于 2013-08-23 12:54:54 
 * 
 * **********************************************************************/
using System;
using System.IO;
...
namespace SM.BaseControls.util
{
    /// <summary>
    /// Excel操作类
    /// </summary>
    ...
    public class ExcelHelper
    {
        #region 数据导出至Excel文件
        /// <summary>
        /// 导出Excel文件，自动返回可下载的文件流   web项目使用
        /// </summary>
        /// <param name="dtData">System.Data.DataTable 对象</param>
        public static void DataTableExcel(System.Data.DataTable dtData)
        {
        ...
        /// <summary>
        /// 导出Excel文件，转换为可读模式  web项目使用
        /// </summary>
        /// <param name="dtData">DataTable 对象</param>
        ...
        public static DataTable InputFromExcel(string ExcelFilePath, string TableName)
        {
            ...
            //{
            //    MessageBox.Show(TableList[i].ToString());
            //}
